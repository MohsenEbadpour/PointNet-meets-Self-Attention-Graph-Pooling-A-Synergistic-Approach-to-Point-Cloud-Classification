...
TrainSet,ValidationSet,TestSet = GetSets(dataset_graph_train,train=1,valid=0)
...
acc,model = Train(model,TrainLoader=TrainLoader,ValidationLoader=TestLoader,
            epoch=100,lr=0.01,weight_decay=0.0005,show=True,name="Self-Attention Graph Pooling-ModelNet10-100epoch-closeness")
